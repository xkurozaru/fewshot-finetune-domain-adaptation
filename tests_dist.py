...
def main():
    ...
    for epoch in range(100, 1001, 100):
        ...
        plt.savefig(f"result/dist_tune_report_{epoch}.png")
        ...
        plt.savefig(f"result/dist_tune_confusion_matrix_{epoch}.png")

    with open("result/dist_tune_f1scores.csv", "a") as f:
